...
/* package JumpDash-0.1.0.0 */
#ifndef VERSION_JumpDash
#define VERSION_JumpDash "0.1.0.0"
#endif /* VERSION_JumpDash */
#ifndef MIN_VERSION_JumpDash
#define MIN_VERSION_JumpDash(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_JumpDash */
...
#define CURRENT_COMPONENT_ID "JumpDash-0.1.0.0-inplace-JumpDash"
